---
name: requirements
description: Stage 1 of the Work Item lifecycle. Reads a Work Item's goal and writes numbered requirements (R1, R2, ...) as a comment on the Issue. Use when a Work Item is at stage:requirements, or after a human rejection.
...
4. If this is a re-run after rejection, say in one line what changed and why.
